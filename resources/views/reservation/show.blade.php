            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/reservation/' . $reservation->id . '/edit') }}" title="Edit Reservation"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Places </th><td> {{ $reservation->places }} </td></tr>
                                </tbody>
                            </table>
                        </div>
